...
#插件初始化完成指示,无返回值
def exfuncpy_init(ourname,ipparm)
    pass

############################## 通知回调 ##############################
#事件通知类型:
# pidchange, phasechange, exitnotify, sigreceived
# ip_up_notifier, ip_down_notifier, auth_up_notifier
# link_down_notifier
#
#事件回调过程: 无返回值,整数IntArg值和通知类型相关,可选参数取决于具体的事件类型
# def notify_callback_f00(IntArg, ...)

#ip_up_notifier: 
def notify_ip_up_notifier(IntArg, ...)
    pass

#ip_down_notifier: 
def notify_ip_down_notifier(IntArg, ...)
    pass
